 ...
 * @author asaidpalamut
 */
public class DestekLogindenController implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cbDepartman.getItems().add("Güvenlik");
        cbDepartman.setDisable(false);
    }    

    @FXML
    private void menuAdminGuncelle(ActionEvent event) {
    }

    @FXML
    private void menuMusteriler(ActionEvent event) {
    }

    @FXML
    private void menuAnasayfa(ActionEvent event) {
    }

    @FXML
    private void menuKategori(ActionEvent event) {
    }

    @FXML
    private void menuUrun(ActionEvent event) {
    }

    @FXML
    private void menuSatisGecmisi(ActionEvent event) {
    }

    @FXML
    private void menuStokTakip(ActionEvent event) {
    }

    @FXML
    private void menuDestek(ActionEvent event) {
    }

    @FXML
    private void menuSepet(ActionEvent event) {
    }
